  ...
  \begin{table}
    ...
    \begin{tabular}{ c | p{4,5cm} | p{4,5cm} | p{4,5cm} }
      ...
      \texttt{postMessage}    & No throttling
                              & No throttling
                              & No throttling, but page gets reloaded after around 8 minutes in the background \\
      \hline
