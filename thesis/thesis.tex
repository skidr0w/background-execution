...
\tableofcontents
  ...
  \newpage
  \chapter{Evaluation of tracing results}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{images/pinned-tab.png}
